...
//        }
    ...
    fun beginRuntimeSocksPort() {
        ...
        // IANA "dynamic/private" range minus a small cushion at the very top.
        // Also keep clear of 49152 so we don't accidentally collide with the
        // DNS port base used elsewhere.
        val random = java.security.SecureRandom()
        runtimeSocksPort = 20000 + random.nextInt(40000) // 20000..59999
    }
